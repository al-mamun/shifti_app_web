 ...
 * @property mixed $all_grocery_product
 */
class GroceryProductListCategoryWiseResource extends JsonResource
{
    /**
    ...
    public function toArray($request): array
    {
        return [
            ...
            'grocery_product' => GroceryProductListResource::collection($this->all_grocery_product)
        ];
    }
}
