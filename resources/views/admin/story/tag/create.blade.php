    ...
    <div class="container-fluid">
        <div class="page-header">
	       ...
	       @if(Session::has('success'))
	        ...
	        <div class="card">
			    <div class="card-body">
				    <form action="{{route('sotrytag.store')}}" method="POST" enctype="multipart/form-data">
				    	@csrf
				        <div class="row">
				            <div class="col-md-6 mb-3">
				                <label for="validationDefault01">Name</label>
				                <input class="form-control" id="validationDefault01" name="tag_name" type="text" placeholder="Tag name" data-original-title="" title="Tag Name" value="{{old('tag_name')}}" />
				            </div>
				        </div>
