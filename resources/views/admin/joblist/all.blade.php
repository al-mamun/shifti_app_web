        ...
        <div class="page-header">
            ...
            <div class="col-sm-12">
                <div class="card-jobs">
                     <div class="row">
                          <div class="col-md-6">
        	              	<h3>Open Jobs <span class="open-job"><a href="{{ url('/admin/joblist') }}" class="btn btn-primary btn-xs text-white view_all" title="open"> Job List </a></span></h3>
        	            </div>
                    ...
                    <div>
                      	<div class="dt-ext">
                      	 <table class="display" id="joblist">
    	                        <thead>
    	                          	<tr>
    		                            <th>Role</th>
    		                            <th>Location</th>
