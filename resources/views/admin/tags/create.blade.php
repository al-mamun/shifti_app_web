	        ...
	        <div class="card">
			    <div class="card-body">
				    <form action="{{route('tags.store')}}" method="POST" enctype="multipart/form-data">
				        ...
				        <input class="form-control" id="status" name="Status" type="hidden" placeholder="Status"  value="1" />
				  
				        <input class="form-control" id="order_bt" name="order_by" type="hidden" placeholder="Tag name" value="0" />
